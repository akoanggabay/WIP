<?php
include_once("../classes/efai017.php");
...
$efai017->setcustcode($intlotdata2->custcode);
$efai017->setintlot($intlotno);
$efai017->setwswr($data->wswr);
$efai017->setswrno($data->swrno);
$efai017->setpackagetype($data->packagetype);
$efai017->setstripno($data->stripno);
$efai017->setpackagethickness($data->packagethickness);
$efai017->setpackagesize($data->packagesize);
$efai017->setarraysize($data->arraysize);
$efai017->setinspectiontype($data->inspectiontype);
$efai017->setremarks($data->remarks);
$efai017->setlastupdatedby($_SESSION['idno']);
$success = $efai017->Addefai017();
