                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                <input type="text" id="wptime015" name="wptime015"  class="form-control input-sm wp015 su">
                                                            </div>
                                                        </div>
                                                        <br/>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                <input type="text" id="wprpm015" name="wprpm015"  class="form-control input-sm wp015 su">
                                                            </div>
                                                        </div>
                                                        <br/>
...
<script>
    ...
    $('#btnDone015').click(async function(event) {
