<div id="010" class="efai" hidden>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select class="form-control req010" id="wsize" name="wsize">
                                                            <option value=""></option>
                                                            <option value="N/A">N/A</option>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-danger" id="btnAddDefect010" name = "btnAddDefect010">Add Reject</button>
                    </div>
                </div>
    ...
    <br/>
    <div class="form-group">
        <button type="button" class="btn btn-success" id="btnDone010" name = "btnDone010" value="done">Done</button>
    </div>
</div>
<br/>
...
<script>
    ...
    $('#btnDone010').click(async function(event) {
