...
class efai019 {
    ...
    public function setsamplingplan($samplingplan){$this->samplingplan=$samplingplan;}
    public function setsamplingsize($samplingsize){$this->samplingsize=$samplingsize;}
    ...
    public function getsamplingplan(){return $this->samplingplan;}
    public function getsamplingsize(){return $this->samplingsize;}
    ...
    public function AddeFAI019(){
		...
		try{
			...
			$con = $conn->open();
            $sql = "INSERT INTO dbo.efai019 (custcode,intlot,wswr,swrno,packagetype,stripno,packagethickness,packagesize,arraysize,samplingplan,samplingsize,remarks,lastupdate,lastupdatedby,active) 
            VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
