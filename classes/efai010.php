...
class efai010 {
    ...
    public function AddeFAI010(){
		...
		try{
			...
			$con = $conn->open();
            $sql = "INSERT INTO dbo.efai010 (custcode,intlot,wswr,swrno,wafertype,inktype,inkused,inkexpdate,inkexpired,inkviresult,inspectiontype,remarks,lastupdate,lastupdatedby,active,wafersaw) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $params = array($this->getcustcode(),$this->getintlot(),$this->getwswr(),$this->getswrno(),$this->getwafertype(),$this->getinktype(),$this->getinkused(),$this->getinkexpdate(),$this->getinkexpired(),$this->getinkviresult(),$this->getinspectiontype(),$this->getremarks(),date("Y-m-d H:i:sa"),$this->getlastupdatedby(),1,$this->getwafersaw());
