...
class efai006 {
    ...
    public function AddeFAI006(){
		...
		try{
			...
			$con = $conn->open();
            $sql = "INSERT INTO dbo.efai006 (custcode,intlot,wswr,swrno,wafercondition,wafertype,tapetype,tapeused,tapethickness,requiredwaferthickness,actualwaferthickness,requiredwaferorientation,actualwaferorientation,highmaginspectionrequired,remarks,lastupdate,lastupdatedby,active,wafersize) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $params = array($this->getcustcode(),$this->getintlot(),$this->getwswr(),$this->getswrno(),$this->getwafercondition(),$this->getwafertype(),$this->gettapetype(),$this->gettapeused(),$this->gettapethickness(),$this->getrequiredwaferthickness(),$this->getactualwaferthickness(),$this->getrequiredwaferorientation(),$this->getactualwaferorientation(),$this->gethighmaginspectionrequired(),$this->getremarks(),date("Y-m-d H:i:sa"),$this->getlastupdatedby(),1,$this->getwafersize());
