...
class Thickness {
	...
	public static function GetAllThicknessLogs($intlotno)
	{
		...
		try{
			...
			where intlotno = '".$intlotno."' and a.waferno != 'N/A' and a.lastupdate = (SELECT TOP 1 lastupdate FROM thickness where intlotno = '".$intlotno."' and waferno != 'N/A') order by lastupdate asc");
